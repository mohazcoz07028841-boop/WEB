...
async function main() {
  ...
  await db.setting.upsert({
    ...
    update: {
      ...
      heroSubheading:
        "SUDMO Company Limited was founded in 2024 to provide quality services in real estate, business consultancy, information technology, and quality electronics and computer equipment.",
