...
export async function POST(request: Request) {
  ...
  const settings = await db.setting.upsert({
    ...
    update: {
      ...
      heroHeading: body.heroHeading ? String(body.heroHeading) : null,
      heroSubheading: body.heroSubheading ? String(body.heroSubheading) : null,
      heroCta: body.heroCta ? String(body.heroCta) : null,
      heroSecondaryCta: body.heroSecondaryCta ? String(body.heroSecondaryCta) : null,
      aboutIntro: body.aboutIntro ? String(body.aboutIntro) : null,
